...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		int count=0; boolean prevVowel= false;
		...
		int len= word.length();
		if(word.charAt(len-1) == 'e' && count > 1 && "aeiouy".indexOf(word.charAt(len-2)) == -1)
			count--;
	    return count;
	}
	...
	public double getFleschScore()
	{
		...
		int w= getNumWords(), s= getNumSentences(), syll= getNumSyllables();
