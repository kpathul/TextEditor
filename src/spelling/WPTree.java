...
public class WPTree implements WordPath {
	...
	{
	    // TODO: Implement this method.t
		root= new WPTreeNode(word1);
		
		LinkedList<WPTreeNode> queue = new LinkedList<WPTreeNode>();     // String to explore
		...
		while(!queue.isEmpty()) {
			...
			List<String> currList= nw.distanceOne(curr.getWord(), true);
